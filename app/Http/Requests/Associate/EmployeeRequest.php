...
class EmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        elseif($this->step == 3){
            return [
                ...
                'birth_date' => ['bail','required','date','before:today', new CalculateAge('4')],
            ...
            if($this->department_id == 1)
            {
                if($this->profession_id == 1)
                {
                    return [
                        ...
                        'euin_validity' => ['bail','nullable','required','after:today'],
    ...
    public function messages()
    {
        ...
        elseif($this->step == 4){
            return [
                ...
                'c_address_upload.max' => 'Max Size 500kb',
                ...
                'p_address_upload.max' => 'Max Size 500kb',
            ];
        }
        //step5
        elseif($this->step == 5)
        {
            ...
            return [
                ...
                'euin_name.required' => 'Enter Name',
                'euin_name.required_if' =>'Enter Name',
                'euin_no.required' => 'Enter Certificate No',
                'euin_no.required_if' =>'Enter Certificate No',
                'euin_upload.required' => 'Upload Certificate',
                'euin_upload.mimes' => 'Not a Proper Format',
                'euin_upload.max' => 'Max Size 500kb',
                'euin_validity.required_if' => 'Enter Certificate Validity',
                'euin_validity.required' => 'Enter Certificate Validity',
                ...
                'reject_reason.required_if' => 'Please enter reason',
            ];
        }
    ...
    protected function getValidatorInstance()
    {
        ...
        $validator->sometimes('p_address_upload', 'required', function($input) {
            return $input->is_permanent_address == 0 && $input->is_p_address_upload == 0  && $input->step == 4;
        });
        $validator->sometimes('nism_va_upload', 'required', function($input) {
            return $input->nism_va_no != null && $input->is_nism_va_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('euin_upload', 'required', function($input) {
            return $input->euin_upload != null && $input->is_euin_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('nism_xa_upload', 'required', function($input) {
            return $input->nism_xa_no != null && $input->is_nism_xa_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('nism_xb_upload', 'required', function($input) {
            return $input->nism_xb_no != null && $input->is_nism_xb_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('cfp_upload', 'required', function($input) {
            return $input->cfp_no != null && $input->is_cfp_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('cwm_upload', 'required', function($input) {
            return $input->cwm_no != null && $input->is_cwm_upload == 0  && $input->step == 6;
        });
        $validator->sometimes('ca_upload', 'required', function($input) {
            return $input->is_ca_upload == 0  && $input->step == 6 && $input->ca_type == 1;
        });
        $validator->sometimes('cs_upload', 'required', function($input) {
            return $input->is_cs_upload == 0  && $input->step == 6 && $input->cs_type == 1;
        });
        $validator->sometimes('course_upload', 'required', function($input) {
            return $input->is_course_upload == 0  && $input->step == 6 && $input->ot_type == 1;
        });
        return $validator;
    }
