...
function nextSteper(current,isAccount,id='')
{
    ...
    {
        $.get("/encrypt?data="+aid, function(data, status){
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    if(data.status == 7)
                    {
                        window.location.replace("/external-associate/"+data_id+"/rejected");
                    }else{
                        window.location.replace('/external-associate/create?id='+data_id);
                    }
                },
        ...
        //     $.get("/encrypt?data="+aid, function(data, status){
        //         //window.location.href = '/associate/'+data;
        //         window.location.replace('/external-associate/'+data+'/edit');
        //     });
        // }else{
        //     $.get("/encrypt?data="+aid, function(data, status){
        //         //window.location.href = '/associate/'+data;
        //         window.location.replace('/external-associate/'+data+'/rejected');
        //     });
        // }
