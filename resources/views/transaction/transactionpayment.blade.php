...
//dd($client);
                                ...
                                //dd($portfolio);
                                    ...
                                    $cheque_upload = '';
                                    $bank_id = '';
                                    //dd($client->payment_mode);
                                    if($client->payment_mode == 'Cheque')
                                    {
                                        $cheque_number = $portfolio->cheque_number;
                                        $cheque_date = Carbon\Carbon::parse($portfolio->cheque_date)->format('d-m-Y') ;
                                        $cheque_upload = $portfolio->cheque_upload;
                                        $cheque_bank_id = $portfolio->bank_id;
                                        //dd($cheque_upload);
                                    }
                                ...
                                <div class="card small-card mb-4">
                                    <div class="card-header">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('transactionlog.type.show',['transactionlog'=>strtolower($client->type),'type'=>strtolower($portfolio->fund_category),'id' => \App\Services\Security::encryptData($portfolio->id)]) }}" class="btn btn-link"><svg width="30" height="30"
                                                viewBox="0 0 24 24">
                                ...
                                <div class="radio-collapse">
                                    <div class="payment-section @if($client->payment_mode == null) {{'selected'}} @else @if($client->payment_mode == 'OTM') {{'selected'}} @endif @endif mb-2">
                                        <div class="form-group custom-radio-btn mb-0">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="payment" id="otm" value="OTM" {{ ($client->payment_mode == 'OTM') ? 'checked' : '' }} @if($client->payment_mode == null) {{'checked'}} @endif>
                                    ...
                                    <div class="payment-section @if($client->payment_mode == 'NEFT/RTGS') {{'selected'}} @endif mb-2">
                                        <div class="form-group custom-radio-btn mb-0">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="payment"
                                                    id="NEFT/RTGS" value="NEFT/RTGS" {{ ($client->payment_mode == 'NEFT/RTGS') ? 'checked' : '' }}>
                                    ...
                                    @php
                                     //dd($client);
                                    @endphp
                                    <div class="payment-section @if($client->payment_mode == 'Net Banking') {{'selected'}} @endif mb-2">
                                        <div class="form-group custom-radio-btn mb-0">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="payment"
                                                    id="Net Banking" value="Net Banking" {{ ($client->payment_mode == 'Net Banking') ? 'checked' : '' }}>
                                    ...
                                    <div class="payment-section @if($client->payment_mode == 'Cheque') {{'selected'}} @endif mb-2">
                                        <div class="form-group custom-radio-btn mb-0">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="payment" id="Cheque" value="Cheque" {{ ($client->payment_mode == 'Cheque') ? 'checked' : '' }}>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="cheque_number" id="cheque_number" placeholder="Enter Cheque Number" value="{{ old('cheque_number', $cheque_number) }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label>Cheque Date</label>
                                                        <input type="text" class="form-control cheque_date" name="cheque_date" id="cheque_date" placeholder="Enter Cheque Date" value="{{ old('cheque_date', $cheque_date) }}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <select class="form-control" name="cheque_bank_id" id="cheque_bank_id">
                                                            <option value="" disabled selected>Select Bank</option>
                                                            @foreach ($client->client_profile->banks as $bank)
                                                                <option value="{{ $bank->id }}" @if(old('cheque_bank_id',$cheque_bank_id) == $bank->id) {{'selected'}} @endif>{{ $bank->bank_name }} ({{ $bank->account_no }})</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        @if (isset($cheque_upload) && !empty($cheque_upload))
                                                        <label class="w-100">
                                                            <span class="text-lowercase font-italic"><a href="javascript:showImage('{{ $cheque_upload }}')" data-src="{{ $cheque_upload }}">Preview</a></span>
                                                        </label>
                                                        @endif
                                                    </div>
                                                </div>
