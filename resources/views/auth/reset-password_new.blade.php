...
<div class="card auth-card">
    <div class="card-body">
        ...
        <form method="POST" id="reset_password-pin" action="{{ route('password.update') }}">
            @csrf
            ...
            <div id="reset2" class="d-none">
                ...
                <button id="resetpin" class="btn btn-primary w-100 btn-lg text-uppercase" onclick="submitForm()" type="submit">Save</button>
            </div>
        </form>
    </div>
</div>
