                            ...
                            <ul class="nav nav-tabs mb-4" id="master_uploads_tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-toggle="tab" href="#scheme-master"
                                        role="tab" aria-selected="true">Scheme Master</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="master_uploads">
                                <div class="tab-pane fade active show" id="scheme-master" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">UPLOAD NEW - SCHEME MASTER</h5>
                                            @if(isset($date))
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form enctype="multipart/form-data" id="upload-scheme" method="POST" action="{{ route('scheme_upload.store') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-xl-4 col-sm-12">
                                                        <div class="form-group mb-3 mb-sm-0">
                                                            <label for="masterscheme_upload">Upload</label>
                                                            <label for="masterscheme_upload" class="btn input-btn w-100">

                                                                <svg width="24" height="24" viewBox="0 0 24 24">
                                                                    <use xlink:href="#upload"></use>
                                                                </svg>
                                                                <input id="masterscheme_upload" type="file" name="masterscheme_upload">
