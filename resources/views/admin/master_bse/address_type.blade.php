                                ...
                                <div class="tab-pane fade show active" id="admin-tax" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form id="add-update-data" method="POST" action="{{ route('addresstype.store') }}">
                                            @csrf
...
<script>
    ...
    {
        $.get("/admin/master/addresstype?id="+$id, function(output, status){
    ...
    {
        let data = '';
        $.get("/admin/master/addresstype?name="+value, function(output, status){
            console.log(output);
    ...
    $( "form#add-update-data" ).submit(function(e) {
        ...
        if($('input[name=name]').prop('readonly')){ return false;}
        $.ajax({
            type: post,
            url: url,
            data: data,
