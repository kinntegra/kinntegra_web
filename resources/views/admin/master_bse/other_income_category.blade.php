                                ...
                                <div class="tab-pane fade show active" id="admin-tax" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form id="add-update-data" method="POST" action="{{ route('incomecategory.store') }}">
                                            @csrf
...
<script>
    ...
    {
        $.get("/admin/master/incomecategory?id="+$id, function(output, status){
    ...
    {
        let data = '';
        $.get("/admin/master/incomecategory?name="+value, function(output, status){
            console.log(output);
