                ...
                <div class="row flex-row-reverse ">
                            ...
                            <ul class="nav nav-tabs mb-4" id="lead-generation" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-toggle="tab" href="#admin-tax"
                                        role="tab" aria-selected="true">Kyc Status</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="admin-tax" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form id="add-update-data" method="POST" action="{{ route('kycstatus.store') }}">
                                            @csrf
                    ...
                    <div class="col-lg-3 col-md-5">
                        ...
                        <ul class="logs-list mt-4">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="return viewEditFunction({{$status->id}});"><h4>{{$status->name}}</h4></a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
...
<script>
    ...
    {
        $.get("/admin/master/kycstatus?id="+$id, function(output, status){
    ...
    function master_search(value)
    {
        let data = '';
        console.log('shashi');
        $.get("/admin/master/kycstatus?name="+value, function(output, status){
            console.log(output);
