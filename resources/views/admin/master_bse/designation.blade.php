...
<div class="panel-wrapper">
    ...
    <div class="container-fluid">
        ...
        <h3 class="section-title mb-4 d-flex justify-content-between">Designation
                ...
                <div class="row flex-row-reverse ">
                            ...
                            <ul class="nav nav-tabs mb-4" id="lead-generation" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-toggle="tab" href="#admin-tax"
                                        role="tab" aria-selected="true">Designation</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="admin-tax" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form id="add-update-data" method="POST" action="{{ route('designation.store') }}">
                                            @csrf
                    ...
                    <div class="col-lg-3 col-md-5">
                        ...
                        <ul class="logs-list mt-4">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="return viewEditFunction({{$designation->id}});"><h4>{{$designation->name}}</h4></a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
...
<script>
    ...
    {
        $.get("/admin/master/designation?id="+$id, function(output, status){
    ...
    {
        let data = '';
        $.get("/admin/master/designation?name="+value, function(output, status){
            //console.log(output);
