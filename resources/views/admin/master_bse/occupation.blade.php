                ...
                <div class="row flex-row-reverse ">
                                ...
                                <div class="tab-pane fade show active" id="admin-tax" role="tabpanel">
                                    <div class="card small-card option-2 option-2 mb-4">
                                        ...
                                        <div class="card-body pt-4 pb-4">
                                            <form id="add-update-data" method="POST" action="{{ route('occupation.store') }}">
                                            @csrf
                    ...
                    <div class="col-lg-3 col-md-5">
                        ...
                        <ul class="logs-list mt-4">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="return viewEditFunction({{$occupation->id}});"><h4>{{$occupation->name}}</h4></a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
...
<script>
    ...
    {
        $.get("/admin/master/occupation?id="+$id, function(output, status){
    ...
    {
        let data = '';
        $.get("/admin/master/occupation?name="+value, function(output, status){
            console.log(output);
