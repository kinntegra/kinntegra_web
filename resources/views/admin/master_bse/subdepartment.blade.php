...
<div class="panel-wrapper">
    ...
    <div class="container-fluid">
        ...
        <h3 class="section-title mb-4 d-flex justify-content-between">Department Name :: {{ $depart->name }}
                            ...
                            <ul class="nav nav-tabs mb-4" id="lead-generation" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-toggle="tab" href="#admin-tax"
                                        role="tab" aria-selected="true">SubDepartment</a>
                                </li>
                            </ul>
...
<script>
    ...
    function viewEditFunction($id)
    {
        ...
        $.get("/admin/master/department?main_id="+$id+"&id="+$parent_id, function(output, status){
            console.log(output);
    ...
    function master_search(value)
    {
        let data = '';
        $parent_id = $("input[name=parent_id]").val();
        $.get("/admin/master/department?name="+value+"&id="+$parent_id, function(output, status){
            //console.log(output);
