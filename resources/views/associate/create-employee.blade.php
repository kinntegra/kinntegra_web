    ...
    <div class="card w-100">
        <div class="card-body p-0">
            <div class="row">
                ...
                <form class="col-lg-8 col-xl-9 step-forms col-md-8 pl-0" enctype="multipart/form-data" id="form-information" method="POST" action="{{ route('employee.store') }}">
                    @csrf
                                        ...
                                        <div class="row flex-column">
                                            ...
                                            <div class="col-sm-8 associate_id">
                                                <div class="form-group">
                                                    ...
                                                    <label for="associate_id">Associate Name <span class="required-sign">*</span></label>
                                            ...
                                            <div class="col-sm-8 name">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-capitalize" id="name" name="name" aria-describedby="name" value="{{ @$data->name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 subdepartment_id">
                                                <div class="form-group">
                                                    <label for="subdepartment_id">Sub Department <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-8 designation_id">
                                                <div class="form-group">
                                                    <label for="designation_id">Grade <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-8 supervisor_id">
                                                <div class="form-group">
                                                    <label for="supervisor_id">Supervised By <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                    ...
                                    <div class="col-xl-8 col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 blood_group">
                                                <div class="form-group">
                                                    <label for="blood_group">Blood Group <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                        ...
                                        <div class="row" id="emergency_contact_1">
                                            ...
                                            <div class="col-sm-12 contact_name1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-uppercase" id="contact_name1" name="contact_name1" value="{{ @$data->contact_name1 }}" aria-describedby="contact_name1" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 contact_mobile1">
                                                <div class="form-group">
                                                    <label for="contact_mobile1">Mobile Number <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control" id="contact_mobile1" value="{{ @$data->contact_mobile1 }}" aria-describedby="contact_mobile1" name="contact_mobile1">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 contact_email1">
                                                <div class="form-group">
                                                    <label for="contact_email1">EMAIL ADDRESS <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control" id="contact_email1" value="{{ @$data->contact_email1 }}" aria-describedby="contact_email1" name="contact_email1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" id="emergency_contact_2">
                                            ...
                                            <div class="col-sm-12 contact_name2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-uppercase" id="contact_name2" name="contact_name2" value="{{ @$data->contact_name2 }}" aria-describedby="contact_name2">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 contact_mobile2">
                                                <div class="form-group">
                                                    <label for="contact_mobile2">Mobile Number <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control" id="contact_mobile2" value="{{ @$data->contact_mobile2 }}" aria-describedby="contact_mobile2" name="contact_mobile2">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 contact_email2">
                                                <div class="form-group">
                                                    <label for="contact_email2">EMAIL ADDRESS <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control" id="contact_email2" value="{{ @$data->contact_email2 }}" aria-describedby="contact_email2" name="contact_email2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 birth_date">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="birth_date" class="form-control" id="birth_date" aria-describedby="birth_date" value="@if(isset($data->birth_date)){{ \Carbon\Carbon::parse(@$data->birth_date)->format('d-m-Y')}}@endif">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 anniversary_date">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="anniversary_date" class="form-control" id="anniversary_date" aria-describedby="anniversary_date" value="@if(isset($data->anniversary_date)){{ \Carbon\Carbon::parse(@$data->anniversary_date)->format('d-m-Y')}}@endif">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-8 col-lg-9">
                                        <div class="row" id="correspondence_address">
                                            ...
                                            <div class="col-sm-12 c_address1">
                                                <div class="form-group ">
                                                    <label for="c_address1">Address 1 <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="c_address1" value="{{ @$data->c_address1 }}" aria-describedby="c_address1" name="c_address1">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 c_address2">
                                                <div class="form-group ">
                                                    <label for="c_address2">Address 2 <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="c_address2" value="{{ @$data->c_address2 }}" aria-describedby="c_address2" name="c_address2">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 c_address3">
                                                <div class="form-group">
                                                    <label for="c_address3">Address 3</label>
                                                    <input type="text" class="form-control text-capitalize" id="c_address3" value="{{ @$data->c_address3 }}" aria-describedby="c_address3" name="c_address3">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 c_city">
                                                <div class="form-group">
                                                    <label for="c_city">City <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="c_city" value="{{ @$data->c_city }}" aria-describedby="c_city" name="c_city">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 c_state">
                                                <div class="form-group">
                                                    <label for="c_state">State <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-6 c_country">
                                                <div class="form-group">
                                                    <label for="c_country">Country <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-6 c_pincode">
                                                <div class="form-group">
                                                    <label for="c_pincode">Pincode <span class="required-sign">*</span></label>
                                                    <input type="text" id="c_pincode" class="form-control" value="{{ @$data->c_pincode }}" aria-describedby="c_pincode" name="c_pincode">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row permanent" id="permanent_address">
                                            ...
                                            <div class="col-sm-12 p_address1">
                                                <div class="form-group ">
                                                    <label for="p_address1">Address 1 <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="p_address1" value="{{ @$data->p_address1 }}" aria-describedby="p_address1" name="p_address1">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 p_address2">
                                                <div class="form-group ">
                                                    <label for="p_address2">Address 2 <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="p_address2" value="{{ @$data->p_address2 }}" aria-describedby="p_address2" name="p_address2">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 p_address3">
                                                <div class="form-group">
                                                    <label for="p_address3">Address 3</label>
                                                    <input type="text" class="form-control text-capitalize" id="p_address3" value="{{ @$data->p_address3 }}" aria-describedby="p_address3" name="p_address3">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 p_city">
                                                <div class="form-group">
                                                    <label for="p_city">City <span class="required-sign">*</span></label>
                                                    <input type="text" class="form-control text-capitalize" id="p_city" value="{{ @$data->p_city }}" aria-describedby="p_city" name="p_city">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 p_state">
                                                <div class="form-group">
                                                    <label for="p_state">State <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-6 p_country">
                                                <div class="form-group">
                                                    <label for="p_country">Country <span class="required-sign">*</span></label>
                                                    <div class="select-wrapper exclude">
                                            ...
                                            <div class="col-sm-6 p_pincode">
                                                <div class="form-group">
                                                    <label for="p_pincode">Pincode <span class="required-sign">*</span></label>
                                                    <input type="text" id="p_pincode" class="form-control" value="{{ @$data->p_pincode }}" aria-describedby="p_pincode" name="p_pincode">
                                                </div>
                                            </div>
                    ...
                    <section class="trial {{ $step6 }}" id="certification-detail" data-step="6" autocomplete="off">
                        <div class="form-inner-section">
                                    ...
                                    <div class="col-xl-8 col-lg-9">
                                        <div class="row flex-column" id="mfd_ria_type">
                                            <div class="col-sm-8 mfd_ria_certificate_type">
                                                <div class="form-group">
                                                    <label for="mfd_ria_certificate_type">Certification Type <span class="required-sign">*</span></label>
                                        ...
                                        <div class="row" id="nism_va_details">
                                            ...
                                            <div class="col-sm-8 nism_va_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_va_no" class="form-control" value="{{ @$data->employee_certificate->nism_va_no }}" name="nism_va_no" aria-describedby="nism_va_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 nism_va_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_va_validity" class="form-control" value="{{ @$data->employee_certificate->nism_va_validity }}" name="nism_va_validity" aria-describedby="nism_va_validity">
                                        ...
                                        <div class="row" id="euin_details">
                                            ...
                                            <div class="col-sm-8 euin_name">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-capitalize" id="euin_name" value="{{ @$data->employee_licence->euin_name }}" name="euin_name" aria-describedby="euin_name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 euin_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="euin_validity" class="form-control" value="{{ @$data->employee_licence->euin_validity }}" name="euin_validity" aria-describedby="euin_validity">
                                        ...
                                        <div class="row flex-column" id="ria_type">
                                            ...
                                            <div class="col-sm-8 ria_certificate_type">
                                                <div class="form-group">
                                                    <label for="ria_certificate_type">RIA Certification Type <span class="required-sign">*</span></label>
                                                    <div class="dropdown customMulti">
                                                        <a class="dropdown-toggle select-dropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span class="text-grey">Certification Type</span>
                                                        </a>
                                        ...
                                        <div class="row" id="nism_xa_details">
                                            ...
                                            <div class="col-sm-8 nism_xa_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_xa_no" class="form-control" value="{{ @$data->employee_certificate->nism_xa_no }}" name="nism_xa_no" aria-describedby="nism_xa_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 nism_xa_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_xa_validity" class="form-control" value="{{ @$data->employee_certificate->nism_xa_validity }}" name="nism_xa_validity" aria-describedby="nism_xa_validity">
                                        ...
                                        <div class="row" id="nism_xb_details">
                                            ...
                                            <div class="col-sm-8 nism_xb_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_xb_no" class="form-control" value="{{ @$data->employee_certificate->nism_xb_no }}" name="nism_xb_no" aria-describedby="nism_xb_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 nism_xb_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nism_xb_validity" class="form-control" value="{{ @$data->employee_certificate->nism_xb_validity }}" name="nism_xb_validity" aria-describedby="nism_xb_validity">
                                        ...
                                        <div class="row" id="cfp_details">
                                            ...
                                            <div class="col-sm-8 cfp_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cfp_no" class="form-control" name="cfp_no" value="{{ @$data->employee_certificate->cfp_no }}" aria-describedby="cfp_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 cfp_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cfp_validity" class="form-control" value="{{ @$data->employee_certificate->cfp_validity }}" name="cfp_validity" aria-describedby="cfp_validity">
                                        ...
                                        <div class="row" id="cwm_details">
                                            ...
                                            <div class="col-sm-8 cwm_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cwm_no" class="form-control" name="cwm_no" value="{{ @$data->employee_certificate->cwm_no }}" aria-describedby="cwm_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 cwm_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cwm_validity" class="form-control" value="{{ @$data->employee_certificate->cwm_validity }}" name="cwm_validity" aria-describedby="cwm_validity">
                                        ...
                                        <div class="row flex-column" id="ca_cs_type">
                                            ...
                                            <div class="col-sm-8 ca_cs_certificate_type">
                                                <div class="form-group">
                                                    <label for="ca_cs_certificate_type">Certification Type <span class="required-sign">*</span></label>
                                                    <div class="dropdown customMulti">
                                                        <a class="dropdown-toggle select-dropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span class="text-grey">Certification Type</span>
                                                        </a>
                                        ...
                                        <div class="row" id="ca_details">
                                            ...
                                            <div class="col-sm-8 ca_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="ca_no" class="form-control" name="ca_no" value="{{ @$data->employee_certificate->ca_no }}" aria-describedby="ca_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 ca_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="ca_validity" class="form-control" value="{{ @$data->employee_certificate->ca_validity }}" name="ca_validity" aria-describedby="ca_validity">
                                        ...
                                        <div class="row" id="cs_details">
                                            ...
                                            <div class="col-sm-8 cs_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cs_no" class="form-control" name="cs_no" value="{{ @$data->employee_certificate->cs_no }}" aria-describedby="cs_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 cs_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cs_validity" class="form-control" value="{{ @$data->employee_certificate->cs_validity }}" name="cs_validity" aria-describedby="cs_validity">
                                        ...
                                        <div class="row" id="course_details">
                                            ...
                                            <div class="col-sm-8 course_name">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="course_name" class="form-control" value="{{ @$data->employee_certificate->course_name }}" name="course_name" aria-describedby="course_name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 course_no">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="course_no" class="form-control" value="{{ @$data->employee_certificate->course_no }}" name="course_no" aria-describedby="course_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8 course_validity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="course_validity" class="form-control" value="{{ @$data->employee_certificate->course_validity }}" name="course_validity" aria-describedby="course_validity">
                            ...
                            <div class="form-footer">
                                ...
                                <button type="button" class="proceed btn btn-primary btn-lg mr-3">Verify</button>
                                <button type="button" class="reject-now btn btn-danger btn-lg">Reject</button>
                                @else
                                @if ($details == 0)
                                <button type="button" class="proceed btn btn-primary btn-lg">Confirm</button>
                                @elseif($details == 1 && ($data->status == 8 || $data->status == 10) && $data->department_id == 1)
                                <button type="button" class="proceed btn btn-primary btn-lg">Confirm</button>
