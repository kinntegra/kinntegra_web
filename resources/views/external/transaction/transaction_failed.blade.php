    ...
    <div class="card w-100">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="text-center">
                        <h3 style="margin-top: 7px;font-size: 23px;margin-left:10px;">Order Failed</h3>
                        <p>This order has been failed. Please contact your associate for further details.</p>
                    </div>
                </div>
            </div>
