    ...
    <div class="card w-100">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="text-center">
                        <h3 style="margin-top: 7px;font-size: 23px;margin-left:10px;">Order Canceled</h3>
                        <p>This order has been canceled by associate. Please contact your associate to re-initiate order.</p>
                    </div>
                </div>
            </div>
